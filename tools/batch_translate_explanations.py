...
def main() -> int:
    ...
    parser.add_argument("--translate-url", default=os.environ.get("CX_TRANSLATE_URL", ""), help="LibreTranslate base URL.")
    parser.add_argument("--api-key", default=os.environ.get("CX_TRANSLATE_API_KEY", ""), help="LibreTranslate API key.")
